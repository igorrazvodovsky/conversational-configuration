...
Candidate frames/comparison (the [nonlinear-interaction](../nonlinear-interaction/requirements.md) agent layer), enumerating every possible repair (top-N by retention suffices), agent tool wrappers (003).
