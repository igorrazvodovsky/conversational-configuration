# Configuration canvas and in-chat controls
...
Multiple named candidates, comparison view, revision-ripple visualization and session resumption/persistence (all [nonlinear interaction](../nonlinear-interaction/requirements.md)); deleting the legacy todo/a2ui example components (housekeeping later); mobile layout.
