...
Canvas rendering, user-initiated state edits from the UI and in-chat generated option controls (all [configuration canvas](../configuration-canvas/requirements.md)); multiple named candidates, comparison, and repair suggestions beyond the minimal conflict explanation (005).
