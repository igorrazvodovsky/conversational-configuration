...
- [../models/Conversation moves.md](../models/Conversation%20moves.md) §2 — all user moves legal at all times, the move-level form of this principle
