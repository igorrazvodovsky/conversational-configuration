...
Status: domain reference, unchanged since 2026-08. Split from the former `docs/research-and-outline.md` §2 ("What a real elevator configuration involves"). Grounds the variable set and scale target of spec [001](../../specs/001-product-model/design.md).
