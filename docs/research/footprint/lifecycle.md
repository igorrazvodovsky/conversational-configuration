...
Status: evidence memo, 2026-08. Split from the former `docs/environmental-footprint-research.md` §1. Provenance tags (*retrieved* / *derived* / *assumed*) as defined in [README.md](../README.md#provenance-tags). Grounds spec [008](../../../specs/008-environmental-footprint/requirements.md).
